...
// ✅ Icons
import { FiHome as HomeIcon, FiBox as BoxIcon, FiShoppingBag, FiShoppingCart } from "react-icons/fi";
  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-32 py-3 border-b border-gray-300 text-gray-700">
      ...
      <ul className="hidden md:flex items-center gap-4">
        ...
        {/* ✅ Cart Icon */}
        <button onClick={() => router.push("/cart")} className="hover:text-gray-900 transition text-xl">
          <FiShoppingCart />
        </button>
        ...
        {isSignedIn ? (
          <UserButton>
            <UserButton.MenuItems>
              ...
              <UserButton.Action label="My Orders" labelIcon={<FiShoppingBag />} onClick={() => router.push("/my-orders")} />
            </UserButton.MenuItems>
          </UserButton>
        ) : (
